prepare_canada_dictionary <- function() {
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "Qoil", full_name = "Oil production in local file", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "OilNetBack", full_name = "Oil Netback", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  # added May 23
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "Koil", full_name = "Capital Investment in Oil", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "Uwar", full_name = "Russian-Ukraine war", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "VAManuwoREF", full_name = "VAManufacturing without oil refinery", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "VAREF", full_name = "VAManufacturing - Oil refinery", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "REFoil", full_name = "Oil refinery (quantity)", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "REFoil_L1", full_name = "Oil refinery (quantity) lag 1", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "CUref", full_name = "Petroleum and coal products manufacturing capacity utilization", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "CrackSpread", full_name = "Crack spread", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "Qgas", full_name = "Natural Gas Production", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "Kgas", full_name = "Capital investment for natural gas", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
  ...
  dictionary <- dictionary %>% add_dict_entry(
    model_varname = "StorageGas", full_name = "Natural gas storage", database = "local", variable_code = NA,
    dataset_id = NA, var_col = "na_item", freq = NA, GEO = NA, geo = "Can",
    unit = NA, s_adj = NA, `Seasonal adjustment` = NA,
    `North American Industry Classification System (NAICS)` = NA, Prices = NA,
    `North American Product Classification System (NAPCS)` = NA, found = NA,
